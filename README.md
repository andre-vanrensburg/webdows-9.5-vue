# Webdows 9.5 (Old PC Simulation) - Vue Version
...
The app is built using Vue and has upcoming versions in React, Angular and Svelte which you will be able to switch to from the task tray or by rebooting...
